...
AVAILABLE_DATA = ["cora", "pubmed", "wikics", "arxiv", 'citeseer', 'arxiv23', 'bookchild', 'bookhis', 'citationv8', 
                  'elecomp', 'elephoto', 'goodreads', 'hepph', 'sportsfit', 'amazonratings', 'products', 'arxivyear', 'dblp', 'tolokers']
...
class SingleGraphOFADataset(OFAPygDataset):
    def gen_data(self):
        ...
        import sys
        sys.path.append('/data/projects/punim1970/iclr2025/TSGFM')
