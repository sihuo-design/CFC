...
def progress_bar(current, total, msg=None, bar_length=50):
    """
    Displays or updates a console progress bar.

    Parameters:
    - current (int): Current iteration or step.
    - total (int): Total number of iterations or steps.
    - msg (str): Additional message to display next to the progress bar.
